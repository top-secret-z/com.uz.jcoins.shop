...
class JCoinsShopItemAddForm extends AbstractForm
{
    ...
    public function readFormParameters()
    {
        ...
        if (isset($_POST['itemTitle'])) {
            $this->itemTitle = StringUtil::trim($_POST['itemTitle']);
        }
        if (isset($_POST['sender'])) {
            $this->sender = StringUtil::trim($_POST['sender']);
        }
        if (isset($_POST['leaveConversation'])) {
            $this->leaveConversation = 1;
        }
        if (isset($_POST['isDisabled'])) {
            $this->isDisabled = 1;
        }
        if (isset($_POST['showStartPage'])) {
        ...
        if (isset($_POST['handsonNames'])) {
            $this->handsonNames = StringUtil::trim($_POST['handsonNames']);
        }
        if (isset($_POST['membershipDays'])) {
            $this->membershipDays = \intval($_POST['membershipDays']);
        }
        if (isset($_POST['membershipID'])) {
            $this->membershipID = \intval($_POST['membershipID']);
        }
        if (isset($_POST['membershipWarn'])) {
            $this->membershipWarn = \intval($_POST['membershipWarn']);
        }
        if (isset($_POST['textItem'])) {
            $this->textItem = StringUtil::trim($_POST['textItem']);
        }
        if (isset($_POST['textItemAutoLimit'])) {
        ...
        if (isset($_POST['price'])) {
            $this->price = \intval($_POST['price']);
        }
        if (isset($_POST['buyLimit'])) {
            $this->buyLimit = \intval($_POST['buyLimit']);
        }
        if (isset($_POST['productLimit'])) {
            $this->productLimit = \intval($_POST['productLimit']);
        }
        if (isset($_POST['sortOrder'])) {
            $this->sortOrder = \intval($_POST['sortOrder']);
        }
        ...
        if (isset($_POST['offerPrice'])) {
            $this->offerPrice = \intval($_POST['offerPrice']);
        }
        ...
        if (isset($_POST['expirationStatus'])) {
            $this->expirationStatus = \intval($_POST['expirationStatus']);
        }
        ...
        $this->autoDisable = 0;
        if (isset($_POST['autoDisable'])) {
            $this->autoDisable = \intval($_POST['autoDisable']);
        }
    ...
    public function validate()
    {
        ...
        if (empty($this->itemTitle)) {
            throw new UserInputException('itemTitle', 'required');
        }
        if (\mb_strlen($this->itemTitle) > 80) {
            throw new UserInputException('itemTitle', 'tooLong');
        }
        ...
        if (empty($this->sender)) {
            throw new UserInputException('sender', 'required');
        }
        if (\mb_strlen($this->sender) > 255) {
            throw new UserInputException('sender', 'tooLong');
        }
        ...
        if ($this->type->typeTitle == 'handson') {
            ...
            if (\count($names) > 20) {
                throw new UserInputException('handsonNames', 'tooMany');
            }
